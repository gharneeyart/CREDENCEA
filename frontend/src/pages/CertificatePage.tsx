...
import { SigBlock } from "@/components/ui/SigBlock";
...
export default function CertificatePage() {
  ...
  const accent = cert.issuerAccentColor || "#7a8fb8";
      ...
      <div style={{ maxWidth: 660, margin: "0 auto" }}>
        ...
        <div style={{ background: parchment, border: `1px solid ${gold}`, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ padding: "8px 60px 32px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: 36, fontFamily: "'Palatino Linotype', Palatino, Georgia, serif", fontStyle: "italic", fontWeight: 400, color: accent, lineHeight: 1.1, margin: "4px 0 16px", paddingBottom: 16, borderBottom: `1.5px solid ${gold}` }}>
            ...
            <div style={{ fontFamily: "'Palatino Linotype', Palatino, Georgia, serif", fontSize: 22, fontWeight: 700, color: accent, marginBottom: 4 }}>
              {meta?.degree || "—"}
            </div>
